...
module.exports = {
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Spiritser' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ sᴘɪʀɪᴛ sᴇʀ' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'sᴘɪʀɪᴛsᴇʀ' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '917994093863@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ sᴘɪʀɪᴛsᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
